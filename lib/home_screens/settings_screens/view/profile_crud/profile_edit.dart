                ...
                GestureDetector(
                  ...
                  child: Obx(() {
                    return CircleAvatar(
                      radius: 50,
                      backgroundColor: Colors.transparent,
                      backgroundImage: _profileController.userModel.value.profilePicUrl.isNotEmpty
                          ? MemoryImage(base64Decode(_profileController.userModel.value.profilePicUrl))
                          : null,
                      child: _profileController.userModel.value.profilePicUrl.isEmpty
                          ? const Icon(
